...
- User can also adjust the Text-to-Speech settings to alter language, speech rate, and pitch. User can also introduce custom pronunciations mapped to specific names
